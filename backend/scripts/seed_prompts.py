...
SEED_PROMPTS = [
    ...
    # ============================================================
    {
        ...
        "supported_models": ["gemini-2.5-flash", "gemini-2.5-flash", "gemini-1.5-pro"],
...
oversaturated, HDR, over-processed, blurry, low quality""",
    ...
    # ============================================================
    {
        ...
        "category": "social_media",
        "generation_type": "copywriting",
        "supported_models": ["gemini-2.5-flash", "gemini-1.5-pro", "gpt-4o"],
        "default_model": "gemini-2.5-flash",
...
不要包含任何與圖片內文字相關的描述。""",
    ...
    # ============================================================
    {
        ...
        "category": "image_prompt",
        "generation_type": "copywriting",
        "supported_models": ["gemini-2.5-flash", "gemini-2.5-flash"],
        "default_model": "gemini-2.5-flash",
        "tags": ["設計", "視覺", "自動化"],
        "is_system": True,
        "is_public": True,
