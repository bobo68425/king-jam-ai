...
def upgrade() -> None:
    ...
    op.create_table('monthly_reports',
        ...
        sa.Column('revenue', sa.Numeric(precision=12, scale=2), server_default='0', nullable=True),
        sa.Column('expenses', sa.Numeric(precision=12, scale=2), server_default='0', nullable=True),
        sa.Column('net_profit', sa.Numeric(precision=12, scale=2), server_default='0', nullable=True),
        sa.Column('withholding_tax', sa.Numeric(precision=12, scale=2), server_default='0', nullable=True),
        sa.Column('distributable_profit', sa.Numeric(precision=12, scale=2), server_default='0', nullable=True),
